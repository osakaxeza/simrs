  ...
  <div class="flex h-screen">
   ...
   <aside class="w-64 bg-[#76A9C5] text-white flex flex-col py-10 px-4 rounded-r-3xl">
      <nav class="space-y-4 font-semibold">
        ...
        <a href="{{ url('/a_pendaftaran') }}" class="flex items-center space-x-2  py-2 px-4 bg-sky-700 rounded-lg text-white">
        ...
        <a href="{{ url('/obat') }}" class="flex items-center space-x-2 py-2 px-4 rounded-lg text-white hover:bg-sky-700 rounded-lg">
    ...
    <main class="flex-1 p-8 overflow-auto">
      <h2 class="text-2xl font-bold text-sky-700 mb-6">Pendaftaran</h2>
